...
ActiveRecord::Schema.define(version: 20160709184830) do
  ...
  create_table "audit_metric_responses", id: false, force: :cascade do |t|
  ...
  create_table "audit_metrics", id: false, force: :cascade do |t|
    t.integer "audit_id",   limit: 8,                   null: false
    t.integer "metric_id",  limit: 3,                   null: false
  ...
  create_table "metric_options", force: :cascade do |t|
    t.integer "metric_id",     limit: 3,                                           null: false
  ...
  create_table "products", force: :cascade do |t|
    ...
    t.integer  "product_category_id",        limit: 4,   default: 1,    null: false
    t.datetime "from"
    t.datetime "till"
  ...
  create_table "store_contacts", id: false, force: :cascade do |t|
    t.integer  "store_id",   limit: 8,   null: false
    t.string   "name",       limit: 100
